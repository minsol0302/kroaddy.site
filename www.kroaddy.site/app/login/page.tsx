        ...
        <div className="min-h-screen px-4 py-8">
            ...
            <div className="flex min-h-screen items-center justify-center">
                <div className="w-full max-w-lg px-6 sm:px-8">
                    ...
                    {/* 모달 스타일 박스 */}
                    <div className={`bg-white rounded-2xl shadow-xl p-6 sm:p-8 space-y-4 sm:space-y-6 opacity-0 animate-fade-in-up ${loginStatus?.success ? 'opacity-50 pointer-events-none' : ''}`}>
                        {/* 중앙 큰 로고 */}
                        <div className="text-center mb-8 space-y-4">
                            ...
                            <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-4xl font-bold animate-float-subtle" style={{ color: '#0A0A0A' }}>Kroaddy</h1>
                        </div>

                        {/* 안내 문구 */}
                        <div className="flex items-center justify-center mb-8">
                            <div className="flex-1 border-t border-gray-300"></div>
                            <p className="px-4 text-sm sm:text-base text-gray-500 font-normal">Log into your account</p>
                            <div className="flex-1 border-t border-gray-300"></div>
                        </div>
